...
import { Card, Pill, Btn, SecHead, Avatar } from "../components/ui";
							...
							>
								<div
									style={{
										...
										color: isSelected ? t.accent : isToday ? t.text : t.textSub,
										marginBottom: 4,
									}}
								>
									{day}
				...
				<Card t={t}>
					<SecHead t={t}>
						{selectedDate === "2026-03-12"
							? "Today — Mar 12"
							: `${MONTHS[month]} ${parseInt(selectedDate.split("-")[2])}`}
					</SecHead>
						...
						selectedEvents.map((e, i) => (
							...
							>
								...
								>
									...
									<Pill
										color={eventTypeColor[e.type] || t.accent}
										dim={(eventTypeColor[e.type] || t.accent) + "18"}
										small
									>
										{e.type}
									</Pill>
								...
								<div style={{ display: "flex", gap: 6, marginTop: 8 }}>
									...
									>
										{AGENTS_DATA.find((a) => a.code === e.agent)?.name}
									</span>
								</div>
							</div>
						))
						...
						>
							...
							>
								...
								<span style={{ fontSize: 9 }}>
									{MONTHS[parseInt(s.date.split("-")[1]) - 1].slice(0, 3)}
								</span>
							</div>
							<div style={{ flex: 1 }}>
