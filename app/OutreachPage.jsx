		...
		<div>
			...
			{tab === "templates" && (
				<div
					style={{
						display: "grid",
						gridTemplateColumns: preview ? "1fr 400px" : "1fr",
						gap: 20,
					}}
					className="crm-outreach-layout"
				>
					<div>
						<div
							style={{
						...
						>
							{EMAIL_TEMPLATES.map((tpl) => (
								<div
									key={tpl.id}
									onClick={() =>
										setPreview(preview?.id === tpl.id ? null : tpl)
									}
									style={{
								...
								>
									...
									>
										<Pill
											color={catColors[tpl.category] || t.accent}
											dim={(catColors[tpl.category] || t.accent) + "18"}
											small
										>
											{tpl.category}
										</Pill>
							...
							>
								...
								<span
									style={{ fontSize: 13, color: t.textMuted, fontWeight: 600 }}
								>
									New Template
								</span>
							</div>
						...
						>
							...
							>
								...
								>
									...
									<br />
									<br />
									[Template continues with dynamic fields for {"{name}"},{" "}
									{"{address}"}, {"{agent_name}"}]
									<br />
									<br />
									Best regards,
					...
					>
						{SEQUENCES.map((seq) => (
							<Card key={seq.id} t={t}>
								...
								<div
									style={{ fontSize: 12, color: t.textSub, marginBottom: 14 }}
								>
